...
public class interfaz2 {
    ...
    public static void createAndShowGUI(Calculator calc) {
        ...
        JFrame frame = new JFrame("Cliente 2 - Calculadora");
        ...
        button0.addActionListener(e -> numberField2.setText(numberField2.getText() + "0"));
        button1.addActionListener(e -> numberField2.setText(numberField2.getText() + "1"));
        button2.addActionListener(e -> numberField2.setText(numberField2.getText() + "2"));
        button3.addActionListener(e -> numberField2.setText(numberField2.getText() + "3"));
        button4.addActionListener(e -> numberField2.setText(numberField2.getText() + "4"));
        button5.addActionListener(e -> numberField2.setText(numberField2.getText() + "5"));
        button6.addActionListener(e -> numberField2.setText(numberField2.getText() + "6"));
        button7.addActionListener(e -> numberField2.setText(numberField2.getText() + "7"));
        button8.addActionListener(e -> numberField2.setText(numberField2.getText() + "8"));
        button9.addActionListener(e -> numberField2.setText(numberField2.getText() + "9"));
        ...
        clear.addActionListener(e -> numberField2.setText(""));
